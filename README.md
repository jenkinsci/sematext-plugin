...
To be able to see your Jenkins metrics you create [Sematext Account][10] and [Sematext Jenkins App][9]
if you didn't do this already. 

### Sematext Agent Installation

To be able to see your Infrastructure and Jenkins JVM metrics you install [Sematext Agent][12] 
...
This plugin collects the following Jenkins [metrics](#metrics). More metrics are collected by the [Sematext Agent][13].  See [Jenkins integration docs][11] for the full list of Jenkins metrics:
...
[6]: https://github.com/jenkinsci/sematext-plugin/blob/master/CONTRIBUTING.md
